...
export default function Player(){
   ...
   window.addEventListener('keydown', (e) => {
       ...
       if(e.code === 'ArrowDown' && e.repeat){
        document.getElementById('Player').style.top = (document.getElementById('Player').style.top + 1)
        ...
        document.getElementById('Player') = (document.getElementById('Player').style.top - 1)
       }
